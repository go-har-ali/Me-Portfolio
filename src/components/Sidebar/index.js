...
import { faHome, faUser, faEnvelope, faBars, faClose, faBriefcase, faLightbulb, faSuitcase } from "@fortawesome/free-solid-svg-icons"
    ...
    <>
        <div className="nav-bar">
            ...
            <ul>
                ...
                <li>
                    <a target="_blank" rel="noreferrer" href='https://www.youtube.com/watch?v=lbc8JjJ8V6g'>
                        <FontAwesomeIcon icon={faYoutube} color="#4d4d4e"/>
                    </a>
                </li>
                <li>
                    <a target="_blank" rel="noreferrer" href='https://github.com/go-har-ali'>
